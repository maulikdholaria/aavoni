...
class CreateUser:
	def __init__(self):
		...
		self.planner_creation_url = 'http://dev.aavoni.com:3001/api/planners/create'
		self.marketCity = 'mumbai'
		self.marketCityId = 4
		self.forCity = 'Mumbai'
...
if __name__ == "__main__":
	with open('/Users/mdholaria/Downloads/planners_india.json') as f:
